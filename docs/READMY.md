...
## Вывод
Написать общий вывод команды:- что получилось;- какие проблемы возникли;- что было самым сложным;- зачем нужны ветки и Pull Request;- почему важно делать Pull перед началом работы.